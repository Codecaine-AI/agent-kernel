...
Prompt: Scout the kernel architecture and context-loading setup for: Research how the Simple Research Kernel should present agents, context loading, subagents, and working memory.
...
## Evidence
- Loaded 4 context inputs (6963 rendered bytes).
