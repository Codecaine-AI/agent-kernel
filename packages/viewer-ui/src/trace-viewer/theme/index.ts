/*
 * Tailwind v4 port note: the v3 `agentPrismTailwindColors` JS color map was
 * removed. Host applications should map `--color-agentprism-*` variables from
 * their own theme layer.
 */
