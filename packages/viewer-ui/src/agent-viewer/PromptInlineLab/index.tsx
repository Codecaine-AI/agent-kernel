  ...
  return (
    ...
    >
      <div className="flex min-h-0 flex-1 overflow-hidden">
        ...
        <div className="flex w-96 shrink-0 flex-col overflow-y-auto border-l border-border bg-card @[72rem]:w-[28rem]">
          {manifest && (
            <AgentZone
              name={manifest.name}
              model={model}
          ...
          {revisionsZone && (
            <div className="border-t border-border">{revisionsZone}</div>
          )}
        </div>
      </div>
    </section>
